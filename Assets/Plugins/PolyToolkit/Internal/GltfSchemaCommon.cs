...
namespace PolyToolkitInternal
{
    ...
    //             {
    //                 m00 = ReadFloat(reader),
    //                 m10 = ReadFloat(reader),
    //                 m20 = ReadFloat(reader),
    //                 m30 = ReadFloat(reader),
    //                 m01 = ReadFloat(reader),
    //                 m11 = ReadFloat(reader),
    //                 m21 = ReadFloat(reader),
    //                 m31 = ReadFloat(reader),
    //                 m02 = ReadFloat(reader),
    //                 m12 = ReadFloat(reader),
    //                 m22 = ReadFloat(reader),
    //                 m32 = ReadFloat(reader),
    //                 m03 = ReadFloat(reader),
    //                 m13 = ReadFloat(reader),
    //                 m23 = ReadFloat(reader),
    //                 m33 = ReadFloat(reader)
    //             };
    //         }
